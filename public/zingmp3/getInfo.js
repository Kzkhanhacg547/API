...
exports.index = async (req, res, next) => {
	...
	try {
		const response = await axios.get(`http://ac.mp3.zing.vn/api/mobile/video/getvideoinfo?keycode=fafd463e2131914934b73310aa34a23f&requestdata={%22id%22:%22${id}%22}`);
